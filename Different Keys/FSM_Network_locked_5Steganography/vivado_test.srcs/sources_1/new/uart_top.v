...
parameter Num_words = 35;
parameter steganography_keybit_length = 280;
parameter key_address_bitlength = 6;
//memory length calculation:
//Ks = 8 states * 3 bit per state = 24 bits. Steganography makes 5 keys value = 24* 5 = 120
//kf = ks = 120
//kt = 8 bit per xt. Steganography makes 3 keys value = 8* 5 = 40
// length = (120 + 120 + 40)/8 = 35 words.
//total bits = 120 + 120 + 40=280
