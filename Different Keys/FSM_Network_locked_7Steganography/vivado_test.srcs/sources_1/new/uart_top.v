...
parameter Num_words = 49;
parameter steganography_keybit_length = 392;
parameter key_address_bitlength = 6;
//memory length calculation:
//Ks = 8 states * 3 bit per state = 24 bits. Steganography makes 7 keys value = 24* 7 = 168
//kf = ks = 168
//kt = 8 bit per xt. Steganography makes 7 keys value = 8* 7 = 56
// length = (168 + 168 + 56)/8 = 49 words.
//total bits = 168 + 168 + 56=392
