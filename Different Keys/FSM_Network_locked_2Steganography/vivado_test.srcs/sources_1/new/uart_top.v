...
parameter Num_words = 14;
parameter steganography_keybit_length = 112;
parameter key_address_bitlength = 4;
//memory length calculation:
//Ks = 8 states * 3 bit per state = 24 bits. Steganography makes 2 keys value = 24* 2 = 48
//kf = ks = 48
//kt = 8 bit per xt. Steganography makes 2 keys value = 8* 2 = 16
// length = (48 + 48 +16)/8 = 14 words.
//total bits = 48+48+16=112
