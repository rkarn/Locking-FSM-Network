...
parameter Num_words = 42;
parameter steganography_keybit_length = 336;
parameter key_address_bitlength = 6;
//memory length calculation:
//Ks = 8 states * 3 bit per state = 24 bits. Steganography makes 6 keys value = 24* 6 = 144
//kf = ks = 144
//kt = 8 bit per xt. Steganography makes 3 keys value = 8* 6 = 48
// length = (144 + 144 + 48)/8 = 42 words.
//total bits = 144 + 144 + 48=336
