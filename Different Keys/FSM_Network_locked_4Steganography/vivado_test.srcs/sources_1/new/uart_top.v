...
parameter Num_words = 28;
parameter steganography_keybit_length = 224;
parameter key_address_bitlength = 5;
//memory length calculation:
//Ks = 8 states * 3 bit per state = 24 bits. Steganography makes 4 keys value = 24* 4 = 96
//kf = ks = 96
//kt = 8 bit per xt. Steganography makes 3 keys value = 8* 4 = 32
// length = (96 + 96 + 32)/8 = 28 words.
//total bits = 96+96+32=224
